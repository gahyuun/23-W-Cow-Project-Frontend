                  ...
                  <CardBody >
                    <Stack divider={<StackDivider />} >
                      <Box>
                        ...
                        <Text pt='2' fontSize='sm'> {state.period} </Text>
                      </Box>
                      <Box>
                        <Heading size='s' textTransform='uppercase'> summary</Heading>
                        <Text pt='2' fontSize='sm'>{state.summary} </Text>
                      </Box>
                      <Box>
                        <Heading size='s' textTransform='uppercase' > techstack</Heading>
                        <Text pt='2' fontSize='sm' display="flex">{state.techstack && state.techstack.map((stack)=>
